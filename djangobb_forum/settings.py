...
# FORUM Settings
FORUM_BASE_TITLE = get('DJANGOBB_FORUM_BASE_TITLE', 'Forum dystrybucji Archlinux')
FORUM_META_DESCRIPTION = get('DJANGOBB_FORUM_META_DESCRIPTION', 'Forum dystrybucji Archlinux')
FORUM_META_KEYWORDS = get('DJANGOBB_FORUM_META_KEYWORDS', 'archlinux, arch, linux, forum, bbs')
...
HEADER = get('DJANGOBB_HEADER', 'Archlinux')
TAGLINE = get('DJANGOBB_TAGLINE', 'Forum społeczności Archlinux')
